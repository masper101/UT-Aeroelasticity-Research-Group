...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% This function finds the average and standard deviation of all vortex
% parameters (i.e. (x,y)-coordinates, core radius, core circulation)
%
% Created: Patrick Mortimer 03/2020
%
% INPUTS:
%        vortex_data = Contains vortex data after filtering process. 
%        (See foutlierdetection)
%
%        The following two inputs are coded in the function. Should be
%        changed as needed. 
%        radius_threshold = Applies additional threshold to eliminate any
%        erroneous vortex core radius calculates that may have been missed
%        in the outlier detection. 
%
% OUTPUTS: The following fields are added to the vortex_data structure
%        avg = contains average data
%           (i)  position = Contains average position, core radius, and core
%                circulation data for each vortex identified at every 
%                azimuthal location
%           (ii) std = Contains standard deviation with 95% confidence for
%                all average data
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
